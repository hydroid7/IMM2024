...
#let m-light-gray = rgb("#EFEFEF")
#let m-dark-gray = rgb("#626262")
#let m-accent = rgb("#FD8900")
#let m-accent-2 = rgb("#F8971C")

#let m-dark-teal = rgb("#545454")
#let m-light-brown = rgb("#F8971C")
...
#let title-slide(
  ...
  let content = {
    ...
    block(width: 100%, inset: 2em, [
      #place(left + top, [
        #image("./figures/logo.png", width: 30%)
      ])
    ])
    block(width: 100%, inset: 2em, {
...
#let slide(title: none, body) = {
  ...
  let footer = {
    ...
    h(1fr)
    text(fill: m-dark-teal, [#logic.logical-slide.display() / #utils.last-slide-number])
  }
